...
// Only enable browser mode when explicitly requested via BROWSER_MODE env var
...
export default defineConfig({
  ...
  test: {
    ...
    // Browser mode configuration for visual/component tests - only when BROWSER_MODE=true
    ...(isBrowserMode && {
      browser: {
        provider: playwright({
          launchOptions: {
